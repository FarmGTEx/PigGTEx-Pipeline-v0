...
summary_path=~/gwas_summary/
tmp_path=~/tmp_data/${type}/
snp_path=~/tissue_snp_chr_pos/
covariance_path=~/GTEx_models/type/${type}/covariances/
SPrediXcan=~/MetaXcan-master/software/
model_path=~/GTEx_models/type/${type}/dbs/
result_path=~/result/${type}/${trait}/
