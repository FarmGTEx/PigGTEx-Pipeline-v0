...
trait_list=(`ls ${userpath}/gwas_summary/`)
Traits=($(echo ${trait_list[*]} | sed 's/.txt.gz//g')) # Extract trait_name
type=exon
METAXCAN=~/MetaXcan-master/software/
snp_covariance=~/smultixcan_covariances/
SPrediXcan_result=~/result/${type}/
