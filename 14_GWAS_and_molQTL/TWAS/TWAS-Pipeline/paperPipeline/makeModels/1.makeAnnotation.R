...
gene_annotation = data.table::fread("../data/Sus_scrofa.Sscrofa11.1.100.chr.gtf")
...
write.table(new_gene_annotation, "../data/new_gene_annotation.txt", row.names = F, quote = F,sep = "\t")
...
#############========================================================================#############
setwd("F:\\task_work\\20220225_Gene_annotation")
### exon
...
write.table(data, "Sus_scrofa.Sscrofa11.1.100.exon.txt", row.names = F, quote = F)
### splicing
...
data = cbind(chr, gene_id, gene_name, start, end, gene_type)
write.table(data, "Sus_scrofa.Sscrofa11.1.100.splicing.txt", row.names = F, quote = F)
### lncRNA
...
data = cbind(chr, gene_id, gene_name, start, end, gene_type)
write.table(data, "Sus_scrofa.Sscrofa11.1.100.lncRNA.txt", row.names = F, quote = F)
